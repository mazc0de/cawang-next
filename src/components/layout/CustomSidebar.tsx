    ...
    return (
        <>
            ...
            <aside className={cn('hidden md:flex h-full flex-col border-r-2 border-ink bg-white shrink-0 z-20 overflow-hidden relative select-none', 'transition-[width] duration-300 ease-in-out', isCollapsed ? 'w-[72px]' : 'w-[240px]')}>
                {/* Logo Lockup & Header */}
                <div className="flex items-center border-b-2 border-ink h-[88px] px-3.5 w-[240px] shrink-0">
            ...
            {isMobileOpen && (
                <div
                    className="fixed inset-0 bg-ink/50 backdrop-blur-xs z-40 md:hidden animate-in fade-in-0 duration-200"
            ...
            <aside
                className={cn(
                    ...
                    isMobileOpen
                        ? 'translate-x-0 shadow-hard-lg opacity-100 visible'
                        : '-translate-x-[calc(100%+30px)] shadow-none opacity-0 invisible pointer-events-none',
                )}
            >
                ...
                <div className="flex items-center justify-between border-b-2 border-ink h-[76px] px-4 shrink-0 bg-canvas/50">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            <span className="font-archivo-black text-lg font-bold tracking-tight text-ink uppercase leading-none">
                                CAWANG
                            </span>
                            <span className="font-space-grotesk text-[10px] font-bold text-ink/70 leading-tight mt-0.5">
                                Catat Keuangan
                            </span>
                        </div>
                    </Link>
