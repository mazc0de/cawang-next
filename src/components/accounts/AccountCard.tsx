...
export function AccountCard({ account, onEdit, onDelete, onReconcile }: AccountCardProps) {
  ...
  return (
    <div
      ...
      className="card-neubrutalism bg-white p-5 flex flex-col justify-between gap-5 group hover:-translate-y-1 transition-transform"
    >
      {/* Top: Icon + Name + Badge */}
      ...
      {/* Bottom Actions */}
      <div className="flex items-center justify-between pt-1 border-t-2 border-ink/10">
        <button
